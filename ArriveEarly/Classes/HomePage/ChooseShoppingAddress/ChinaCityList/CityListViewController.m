...
- (void)viewDidLoad
{
    ...
    _searchText.autocorrectionType = UITextAutocorrectionTypeDefault;
    ...
    UIView *lineV = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(searchView.frame)-0.5, CGRectGetWidth(searchView.frame), 0.5)];
...
- (void)setNavigationWithTitle:(NSString *)title
{
    ...
    [backBtn setImage:[UIImage imageNamed:@"dismiss"] forState:UIControlStateNormal];
...
- (void)ininHeaderView
{
    ...
    lastView = _locatingCityGroupView;
    
    //常用城市
    UILabel *title2 = nil;
    if (self.arrayHistoricalCity.count) {
        title2 = [[UILabel alloc]initWithFrame:CGRectMake(10, _locatingCityGroupView.frame.origin.y+_locatingCityGroupView.frame.size.height+10, 160, 21)];
        title2.text = @"常用城市";
    ...
    //热门城市
    UILabel * title3 = nil;
    if (self.arrayHotCity.count) {
        title3 = [[UILabel alloc]initWithFrame:CGRectMake(10, _historicalCityGroupView.frame.origin.y+_historicalCityGroupView.frame.size.height+10, 160, 21)];
        title3.text = @"热门城市";
    ...
    _tableHeaderView.frame = CGRectMake(0, 0, _tableView.frame.size.width, CGRectGetMaxY(lastView.frame)+_hotCityGroupView.frame.size.height );
